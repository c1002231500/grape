...
//send main
 ...
 function mailtool($uid,$rand,$sendmail) {
        ...
        try {
            ...
            $body = "Hi,  <br/>こんにちは<br/>Your Shanghaitimes Account has been successfully created.<br/>ごShanghaitimes申し込みができました。<br/> Please activate your account by visiting link below: <br/> 下のリンクを訪問してアカウントを有効してください：<br/>http://www.shanghaitimes.net/index.php?action=confirmation1&_p=$uid&_r=$rand";
            $body.="<br/><br/>Thank you for using Shanghaitimes!Shanghaitimes<br/>をご利用していただきありがとうございます。";
            $mail->Body=$body;
            if ($mail->Send()) {
//               echo "success";
//               exit;
