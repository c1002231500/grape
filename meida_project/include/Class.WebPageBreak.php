	...
	private function GetPageIndex() {
		...
		for( $i=$first_number; $i<=$last_number; $i++ ) {
			if( $this->mCurPageNumber == $i ) {
				$page_index .= "<span class='page-cur'>".$i."</span>";
			}
			else {
				$page_index .= "<a href='".$this->mQueryString.$i."' >".$i."</a> ";
			}
		}
//		var_dump($page_index);
		return $page_index;
	...
	private function GetNavPreButton() {
		...
		return "<a href='".$this->mQueryString.$pre_number."' class='page-prev'>".$this->mPreButton."</a> ";
	}
	...
	private function GetNavNextButton() {
		...
		return "<a href='".$this->mQueryString.$next_number."' class='page-next' >".$this->mNextButton."</a> ";
	}
