<?php /* Smarty version 2.6.26, created on 2011-09-01 16:01:30
...
<?php 
 ...
 ?>
                			<li><em><a href="javascript:;" id="header_plugin"
				hidefocus="true" onClick="toggleMenu('plugin', '/admin.php?action=Brand_List');">系统设置</a></em></li>
		<!--	<li><em><a href="javascript:;" id="header_style"
				hidefocus="true" onClick="toggleMenu('style', 'User_index');">会员管理</a></em></li>
			 <li><em><a href="javascript:;" id="header_forum" hidefocus="true" onClick="toggleMenu('forum', 'order');">订单管理</a></em></li>
...
-->
	...
	<tr>
		...
		<ul id="menu_global" style="display: none">
            ...
            <li><a href="/admin.php?action=classlist" hidefocus="true" target="main" style="color: red">类别管理</a></li>
		</ul>
		<ul id="menu_forum" style="display: none">
			<li><a href="order" hidefocus="true" target="main">订单一览</a></li>
            <li><a href="ordertoday" hidefocus="true" target="main">今天订单</a></li>
		</ul>
		...
		<ul id="menu_plugin" style="display: none">
         <!--   <li><a href="/admin.php?action=page&page=Add_Document" hidefocus="true" target="main">系统文章列表</a></li>
            ...
            <li><a href="/admin.php?action=classlist" hidefocus="true" target="main">类别维护</a></li>
			<li><a href="Video_Menu_index" hidefocus="true" target="main">添加系统文章</a></li>
            <div style="margin: 0 auto;width: 80%; border-bottom: 1px #999999 solid"></div>
            </li>
		...
		<td valign="top" width="100%" class="mask" id="mainframes"><iframe
			src="/admin.php?action=newslist" id="main" name="main" width="100%" height="100%"
...
<div class="cside">
<h3><span class="ctitle1"></span><a href="javascript:;"
	onClick=
	toggleMenu('tool', 'misc&operation=custommenu');
	hideMenu();;
class="cadmin">管理</a></h3>
...
<script type="text/JavaScript">
	var headers = new Array('index', 'global', 'style', 'forum', 'user',
			'topic', 'extended', 'plugin', 'adv', 'tool', 'uc');
