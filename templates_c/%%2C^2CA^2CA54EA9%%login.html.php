<?php /* Smarty version 2.6.26, created on 2012-11-12 07:05:48
	...
	<div class="warp">
    	<div class="content">
            ...
            <form  name="login" action="/admin.php?login=pass" method="post">
                ...
                <div class="item"><div class="input"><div class="icon2" title="密码"></div><input value="" id="pwd" name="pwd" type="password"></div><label>密码：</label></div>
