<?php /* Smarty version 2.6.26, created on 2012-11-14 04:03:30
         compiled from newadmin/Admin_Xinwen_List.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'substr', 'newadmin/Admin_Xinwen_List.html', 55, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <div class="right">
        	<div class="add">
        	<div style="float:left;"><b><font color="#e50000">新闻管理</font></b></div>
        	</div>
                ...
                <div style="width:798px;height:auto;">
                    	...
                    	<table width="100%" border="0"  style="border-bottom:1px solid #d6d6d6; border-top:1px solid #d6d6d6; background:#e8e7e7" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td align="center" width="30%">标题</td>
...
?>
                          	  <tr>
                                    <td height="60" align="center" width="10%"><?php echo $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_id']; ?>
</td>
                                    <td align="center" width="10%"> 
										<?php if ($this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_pic'] != ''): ?><img src="include/Public/Xinwen/<?php echo $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_pic']; ?>
" width="50" height="50" />
                                        <?php elseif ($this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_pic'] == ''): ?><img src="include/Public/Xinwen/none.jpg" width="50" height="50" />
                                        <?php endif; ?>
									</td>
                                    <td align="center" width="30%"><?php echo $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_title']; ?>
</td>									
									<td align="center" width="10%"><?php echo substring(array('str' => $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_starttime'],'end' => 10), $this);?>
</td>
									<td align="center" width="10%"><?php echo substring(array('str' => $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_acttime'],'end' => 10), $this);?>
</td>
                                    
									
									<td width="10%" align="center" valign="middle" bordercolor="#D6E9EB">
										<div><a href="/admin.php?xid=<?php echo $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_id']; ?>
&action=Xinwen_Edit"><img src="/templates/newadmin/image/htbj.jpg" width="30" height="15"></a></div>
									</td>
									
									<td width="10%" align="center" valign="middle" bordercolor="#D6E9EB">
										<div><a href="javascript:new_del('<?php echo $this->_tpl_vars['flist'][$this->_sections['sec1']['index']]['x_id']; ?>
...
<script type="text/javascript">
    function  new_del(id){
        ...
        $.ajax({
           type: "POST",
           url: "/admin.php",
           data: "action=deleteXinwen&xid="+id,
