<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('collection_add');
0
|| checktplrefresh('./template/default/forum/collection_add.htm', './template/yeei_yeeix2/common/header.htm', 1347606021, '6', './data/template/6_6_forum_collection_add.tpl.php', './template/yeei_yeeix2', 'forum/collection_add')
|| checktplrefresh('./template/default/forum/collection_add.htm', './template/yeei_yeeix2/common/footer.htm', 1347606021, '6', './data/template/6_6_forum_collection_add.tpl.php', './template/yeei_yeeix2', 'forum/collection_add')
|| checktplrefresh('./template/default/forum/collection_add.htm', './template/default/common/header_common.htm', 1347606021, '6', './data/template/6_6_forum_collection_add.tpl.php', './template/yeei_yeeix2', 'forum/collection_add')
|| checktplrefresh('./template/default/forum/collection_add.htm', './template/default/common/pubsearchform.htm', 1347606021, '6', './data/template/6_6_forum_collection_add.tpl.php', './template/yeei_yeeix2', 'forum/collection_add')
;?>
...
<?php if($op == 'edit') { ?>
<a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $_G['collection']['ctid'];?>"><?php echo $_G['collection']['name'];?></a> <em>&rsaquo;</em>
编辑淘专辑
<?php } else { ?>
创建淘专辑
<?php } ?>
...
var desclimit = '<?php echo $desclimit;?>';
function checklen() {
...
<tr>
<th>淘专辑名：</th>
<td><input type="text" value="<?php echo $_G['collection']['name'];?>" name="title" id="formtitle" class="px" /></td>
</tr>
<tr>
<th>淘帖简介：</th>
<td><textarea name="desc" id="formdesc" rows="10" class="pt"><?php echo $_G['collection']['desc'];?></textarea></td>
</tr>
<tr>
<th>淘帖关键词：</th>
<td>
<input type="text" value="<?php echo $_G['collection']['keyword'];?>" name="keyword" id="formkeyword" class="px" />
<p class="xg1">请使用空格隔开关键词，最多可填写 5 个。您可以使用这些关键词和淘贴标题搜索主题，快速创建淘贴专辑。</p>
</td>
</tr>
<tr>
<th></th>
...
<button type="submit" name="collectionsubmit" class="pn pnc" value="submit"><span><?php if($op == 'edit') { ?>编辑淘专辑<?php } else { ?>创建淘专辑<?php } ?></span></button>
<?php if($op != 'edit') { ?>
<span class="xg1">还可以创建 <?php echo $reamincreatenum;?> 个淘专辑</span>
<?php } ?>
</td>
</tr>
</table>
