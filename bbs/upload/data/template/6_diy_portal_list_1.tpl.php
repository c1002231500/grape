...
0
|| checktplrefresh('data/diy/./template/default//portal/list_1.htm', './template/yeei_yeeix2/common/header.htm', 1347606367, 'diy', './data/template/6_diy_portal_list_1.tpl.php', 'data/diy/./template/default/', 'portal/list_1')
|| checktplrefresh('data/diy/./template/default//portal/list_1.htm', './template/yeei_yeeix2/common/footer.htm', 1347606367, 'diy', './data/template/6_diy_portal_list_1.tpl.php', 'data/diy/./template/default/', 'portal/list_1')
|| checktplrefresh('data/diy/./template/default//portal/list_1.htm', './template/default/common/header_common.htm', 1347606367, 'diy', './data/template/6_diy_portal_list_1.tpl.php', 'data/diy/./template/default/', 'portal/list_1')
|| checktplrefresh('data/diy/./template/default//portal/list_1.htm', './template/default/common/pubsearchform.htm', 1347606367, 'diy', './data/template/6_diy_portal_list_1.tpl.php', 'data/diy/./template/default/', 'portal/list_1')
;?>
...
<div id="wp" class="wp"><?php $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><div id="pt" class="bm cl">
<div class="z">
...
<?php if($cat['subs']) { ?>
<div class="bm_c bbda">
下级分类:&nbsp;&nbsp;<?php $i = 1;?><?php if(is_array($cat['subs'])) foreach($cat['subs'] as $value) { if($i != 1) { ?><span class="pipe">|</span><?php } ?><a href="<?php echo getportalcategoryurl($value['catid']);; ?>" class="xi2"><?php echo $value['catname'];?></a><?php $i--;?><?php } ?>
</div>
<?php } ?>
<div class="bm_c xld"><?php if(is_array($list['list'])) foreach($list['list'] as $value) { ?><?php $highlight = article_title_style($value);?><dl class="bbda cl">
...
<dd class="xs2 cl">
<?php if($value['pic']) { ?><div class="atc"><a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank"><img src="<?php echo $value['pic'];?>" alt="<?php echo $value['title'];?>" class="tn" /></a></div><?php } ?>
