...
0
|| checktplrefresh('./template/default/group/index.htm', './template/yeei_yeeix2/common/header.htm', 1347605630, 'diy', './data/template/6_diy_group_index.tpl.php', './template/yeei_yeeix2', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/yeei_yeeix2/common/footer.htm', 1347605630, 'diy', './data/template/6_diy_group_index.tpl.php', './template/yeei_yeeix2', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/default/common/header_common.htm', 1347605630, 'diy', './data/template/6_diy_group_index.tpl.php', './template/yeei_yeeix2', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/default/common/pubsearchform.htm', 1347605630, 'diy', './data/template/6_diy_group_index.tpl.php', './template/yeei_yeeix2', 'group/index')
;?>
