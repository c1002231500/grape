...
0
|| checktplrefresh('./template/yeei_yeeix2/forum/discuz.htm', './template/yeei_yeeix2/common/header.htm', 1347605576, 'diy', './data/template/6_diy_forum_discuz.tpl.php', './template/yeei_yeeix2', 'forum/discuz')
|| checktplrefresh('./template/yeei_yeeix2/forum/discuz.htm', './template/yeei_yeeix2/common/footer.htm', 1347605576, 'diy', './data/template/6_diy_forum_discuz.tpl.php', './template/yeei_yeeix2', 'forum/discuz')
|| checktplrefresh('./template/yeei_yeeix2/forum/discuz.htm', './template/default/common/header_common.htm', 1347605576, 'diy', './data/template/6_diy_forum_discuz.tpl.php', './template/yeei_yeeix2', 'forum/discuz')
|| checktplrefresh('./template/yeei_yeeix2/forum/discuz.htm', './template/default/common/pubsearchform.htm', 1347605576, 'diy', './data/template/6_diy_forum_discuz.tpl.php', './template/yeei_yeeix2', 'forum/discuz')
;?>
...
<div id="wp" class="wp"><div class="yeei_sw">
<div class="yeei_sw1">
<div class="yeei_sw1r">
<?php if(empty($gid)) { ?>
