...
0
|| checktplrefresh('./template/default/portal/portalcp_category.htm', './template/default/portal/portalcp_nav.htm', 1347605842, '6', './data/template/6_6_portal_portalcp_category.tpl.php', './template/yeei_yeeix2', 'portal/portalcp_category')
...
<td><?php if($allowmanage || !empty($permission[$value['catid']]['allowmanage'])) { ?><?php $showflag = true;?><input type="checkbox" value="<?php echo $value['aid'];?>" name="aids[]" class="pc" />
<?php } else { ?>
<?php echo $line;?>
<?php } ?>
</td>
