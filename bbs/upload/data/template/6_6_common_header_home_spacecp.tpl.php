...
0
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/header_common.htm', 1347605908, '6', './data/template/6_6_common_header_home_spacecp.tpl.php', './template/yeei_yeeix2', 'common/header_home_spacecp')
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/pubsearchform.htm', 1347605908, '6', './data/template/6_6_common_header_home_spacecp.tpl.php', './template/yeei_yeeix2', 'common/header_home_spacecp')
;?>
