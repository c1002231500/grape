<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); include template('common/header_ajax'); ?><?php $i = 0;?><table cellspacing="2" cellpadding="2" class="imgl"><tr><?php if(is_array($photolist)) foreach($photolist as $photo) { ?><?php $i++;?><td valign="bottom" width="25%">
