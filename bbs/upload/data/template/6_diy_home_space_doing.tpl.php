...
0
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_header.htm', 1347606541, 'diy', './data/template/6_diy_home_space_doing.tpl.php', './template/yeei_yeeix2', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/common/userabout.htm', 1347606541, 'diy', './data/template/6_diy_home_space_doing.tpl.php', './template/yeei_yeeix2', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_userabout.htm', 1347606541, 'diy', './data/template/6_diy_home_space_doing.tpl.php', './template/yeei_yeeix2', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/common/header_common.htm', 1347606541, 'diy', './data/template/6_diy_home_space_doing.tpl.php', './template/yeei_yeeix2', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_diy.htm', 1347606541, 'diy', './data/template/6_diy_home_space_doing.tpl.php', './template/yeei_yeeix2', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_header_personalnv.htm', 1347606541, 'diy', './data/template/6_diy_home_space_doing.tpl.php', './template/yeei_yeeix2', 'home/space_doing')
;?>
<?php if($diymode) { if($_G['setting']['homepagestyle']) { ?><?php $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
<a href="home.php?mod=space&amp;do=blog">记录</a>
</div>
</div>
...
<?php } if($dolist) { ?>
<div class="xld <?php if(empty($diymode)) { ?>xlda<?php } ?>"><?php if(is_array($dolist)) foreach($dolist as $dv) { ?><?php $doid = $dv[doid];?><?php $_GET[key] = $key = random(8);?><dl id="<?php echo $key;?>dl<?php echo $doid;?>" class="pbn bbda cl">
