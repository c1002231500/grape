...
0
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/header_common.htm', 1347605648, '6', './data/template/6_6_common_header_group_forumdisplay.tpl.php', './template/yeei_yeeix2', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/pubsearchform.htm', 1347605648, '6', './data/template/6_6_common_header_group_forumdisplay.tpl.php', './template/yeei_yeeix2', 'common/header_group_forumdisplay')
;?>
