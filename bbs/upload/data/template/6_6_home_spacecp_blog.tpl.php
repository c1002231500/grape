...
0
|| checktplrefresh('./template/default/home/spacecp_blog.htm', './template/default/home/editor_image_menu.htm', 1347605907, '6', './data/template/6_6_home_spacecp_blog.tpl.php', './template/yeei_yeeix2', 'home/spacecp_blog')
|| checktplrefresh('./template/default/home/spacecp_blog.htm', './template/default/common/seccheck.htm', 1347605907, '6', './data/template/6_6_home_spacecp_blog.tpl.php', './template/yeei_yeeix2', 'home/spacecp_blog')
...
<tr>
<td><script src="<?php echo $_G['setting']['jspath'];?>swfupload.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<?php if($blog['uid'] && $blog['uid']!=$_G['uid']) { ?><?php $selectgroupstyle='display:none';?></table>
...
<?php } if(checkperm('seccode') && ($secqaacheck || $seccodecheck)) { ?><?php $sectpl = '<tr><th><sec></th><td class="pns"><sec><div class="d"><sec></div></td></tr>';?><?php $_G['sechashi'] = !empty($_G['cookie']['sechashi']) ? $_G['sechash'] + 1 : 0;
