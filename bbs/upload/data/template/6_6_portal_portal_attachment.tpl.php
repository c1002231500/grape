...
0
|| checktplrefresh('./template/default/portal/portal_attachment.htm', './template/default/common/header_ajax.htm', 1347606508, '6', './data/template/6_6_portal_portal_attachment.tpl.php', './template/yeei_yeeix2', 'portal/portal_attachment')
|| checktplrefresh('./template/default/portal/portal_attachment.htm', './template/default/common/footer_ajax.htm', 1347606508, '6', './data/template/6_6_portal_portal_attachment.tpl.php', './template/yeei_yeeix2', 'portal/portal_attachment')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
...
<input type="radio" name="setconver" id="setconver<?php echo $attach['attachid'];?>" class="pr" value="1" onclick="setConver('<?php echo $coverstr;?>')">设为封面
</label>
