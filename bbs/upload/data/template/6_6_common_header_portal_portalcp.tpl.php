...
0
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/header_common.htm', 1347605841, '6', './data/template/6_6_common_header_portal_portalcp.tpl.php', './template/yeei_yeeix2', 'common/header_portal_portalcp')
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/pubsearchform.htm', 1347605841, '6', './data/template/6_6_common_header_portal_portalcp.tpl.php', './template/yeei_yeeix2', 'common/header_portal_portalcp')
;?>
