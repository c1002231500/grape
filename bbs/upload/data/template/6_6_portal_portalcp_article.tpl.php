...
0
|| checktplrefresh('./template/default/portal/portalcp_article.htm', './template/default/home/editor_image_menu.htm', 1347606369, '6', './data/template/6_6_portal_portalcp_article.tpl.php', './template/yeei_yeeix2', 'portal/portalcp_article')
|| checktplrefresh('./template/default/portal/portalcp_article.htm', './template/default/common/seccheck.htm', 1347606369, '6', './data/template/6_6_portal_portalcp_article.tpl.php', './template/yeei_yeeix2', 'portal/portalcp_article')
...
<div id="pagetitle" class="dopt mtn cl"<?php if($article['contents'] < 2) { ?> style="display: none"<?php } ?>>
...
<div class="pbw">
<script src="<?php echo STATICURL;?>image/editor/editor_function.js?<?php echo VERHASH;?>" type="text/javascript"></script><script src="<?php echo $_G['setting']['jspath'];?>swfupload.js?<?php echo VERHASH;?>" type="text/javascript"></script>
