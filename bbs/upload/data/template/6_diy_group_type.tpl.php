...
0
|| checktplrefresh('./template/default/group/type.htm', './template/yeei_yeeix2/common/header.htm', 1347605644, 'diy', './data/template/6_diy_group_type.tpl.php', './template/yeei_yeeix2', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/yeei_yeeix2/common/footer.htm', 1347605644, 'diy', './data/template/6_diy_group_type.tpl.php', './template/yeei_yeeix2', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/header_common.htm', 1347605644, 'diy', './data/template/6_diy_group_type.tpl.php', './template/yeei_yeeix2', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/pubsearchform.htm', 1347605644, 'diy', './data/template/6_diy_group_type.tpl.php', './template/yeei_yeeix2', 'group/type')
;?>
