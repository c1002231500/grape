...
0
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/header_common.htm', 1347606169, '6', './data/template/6_6_common_header_forum_post.tpl.php', './template/yeei_yeeix2', 'common/header_forum_post')
|| checktplrefresh('./template/yeei_yeeix2/common/header.htm', './template/default/common/pubsearchform.htm', 1347606169, '6', './data/template/6_6_common_header_forum_post.tpl.php', './template/yeei_yeeix2', 'common/header_forum_post')
;?>
