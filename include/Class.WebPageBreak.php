...
//		var_dump($page_index);
	...
	private function GetNavSelectButton(){
		...
		<input style='width:47px;height:20px;float:left;border:none;' type='image' src='/templates/Content/Public/images/gopic2.jpg' value='go' onclick='tiaozhuan()'>";
	} 
		

	// 得到页码索引条 首页按钮
	private function GetNavFirstButton() {
		return "<a style='text-decoration: none;color:#999999;' href='".$this->mQueryString."1'>".$this->mFirstButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #999999; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>最初</div></a> ";
	}
	...
	private function GetNavPreButton() {
		...
		return "<a style='text-decoration: none;color:#999999;' href='".$this->mQueryString.$pre_number."' class='page-prev'>".$this->mPreButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #999999; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>前へ</div></a> ";
	}
	...
	private function GetNavNextButton() {
		...
		return "<a style='text-decoration: none;color:#999999;' href='".$this->mQueryString.$next_number."' class='page-next' >".$this->mNextButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #999999; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>次へ</div></a> ";
	}

	// 得到页码索引条 末页按钮
	private function GetNavLastButton() {
		return "<a style='text-decoration: none;color:#999999;' href='".$this->mQueryString.$this->mTotalPagesNum."'>".$this->mLastButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #999999; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>最後
</div></a> ";
	}
