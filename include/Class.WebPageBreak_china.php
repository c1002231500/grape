...
//		var_dump($page_index);
	...
	private function GetNavFirstButton() {
		return "<a style='text-decoration: none;color:#7ca900;' href='".$this->mQueryString."1'>".$this->mFirstButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #7ca900; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>首页</div></a> ";
	}
	...
	private function GetNavPreButton() {
		...
		return "<a style='text-decoration: none;color:#7ca900;' href='".$this->mQueryString.$pre_number."' class='page-prev'>".$this->mPreButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #7ca900; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>上一页</div></a> ";
	}
	...
	private function GetNavNextButton() {
		...
		return "<a style='text-decoration: none;color:#7ca900;' href='".$this->mQueryString.$next_number."' class='page-next' >".$this->mNextButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #7ca900; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>下一页</div></a> ";
	}

	// 得到页码索引条 末页按钮
	private function GetNavLastButton() {
		return "<a style='text-decoration: none;color:#7ca900;' href='".$this->mQueryString.$this->mTotalPagesNum."'>".$this->mLastButton."<div style='width:40px; height:18px; text-align:center; line-height:18px; border:1px solid #7ca900; margin-right:3px; float:left; margin-right:3px;cursor: pointer;'>尾页
</div></a> ";
	}
